        ...
        <div class="col-md-6 col-md-offset-3">
            <form:form id="inputForm" role="form" action="${ctx}/product/edit"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" required class="form-control" type="text" value="${product.price}" id="point" name="price"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" id="code" value="${product.description}" name="description"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">全文介绍</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="text" id="model" value="${product.content}" name="content"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="pic">封面图片</label>
                    <div class="col-sm-10">
                        <img class="img-responsive img-rounded" width="300px" src="${ctx}${product.img}">
